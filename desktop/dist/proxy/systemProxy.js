...
export async function setSystemProxyOn(pacPath) {
    ...
    if (platform === "darwin") {
        ...
        throw new Error("PAC toggle for Windows is not implemented in this scaffold.");
    }
...
export async function setSystemProxyOff() {
    ...
    if (platform === "darwin") {
        ...
        throw new Error("Proxy disable for Windows is not implemented in this scaffold.");
    }
    throw new Error("Unsupported platform for system proxy toggle.");
}
export async function setManualSocksOn(host, port) {
    const platform = os.platform();
    if (platform === "darwin") {
        const svc = await resolveServiceName();
